<div class="portlet light">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-table"></i>Post Office List</div>
        <div class="tools">
    ...
    <div class="portlet-window-body">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th class="text-center">Post Office Name (Bangla)</th>
                <th class="text-center">Post Office Name (English)</th>
            ...
            <tr>
                ...
                <td class="text-center"><?php echo $rows['postoffice_name_bng']; ?></td>
                <td class="text-center"><?php echo $rows['postoffice_name_eng']; ?></td>
