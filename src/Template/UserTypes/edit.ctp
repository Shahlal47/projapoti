...
<div class="portlet box blue">
	...
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		 <?= $this->Form->create($userType, ['action' => 'edit','type'=>'post','class'=>'form-horizontal']);?>
			<div class="form-body">
				<div class="form-group">
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<?= $this->Form->input('name',['label'=>false,'class'=>'form-control input-circle-right','type'=>'text','placeholder'=>'Email Address']);?>
						</div>
					</div>
				</div>
			</div>
