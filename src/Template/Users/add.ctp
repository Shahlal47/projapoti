...
<div class="portlet box blue">
	...
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		 <?= $this->Form->create($user, ['action' => 'add','type'=>'post','class'=>'form-horizontal','type'=>'file']);?>
			<div class="form-body">
				<div class="form-group">
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<?= $this->Form->input('username',['label'=>false,'class'=>'form-control input-circle-right','type'=>'text','placeholder'=>'User Name']);?>
						</div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<?= $this->Form->input('user_type_id',['options'=>$userTypes,'label'=>false,'class'=>'form-control','empty'=>'--Select Role--']);?>
					</div>
				</div>
				<div class="form-group">
