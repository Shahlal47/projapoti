...
<div class="inbox-view-info">
	<div class="row">
		<div class="col-md-7">
			<img src="/Applications/MAMP/htdocs/nothi3/webroot/assets/admin/layout/img/avatar1_small.jpg">
			<span class="bold">
			Petronas IT </span>
			<span>
			&#60;support@go.com&#62; </span>
		...
		<div class="inbox-attached">
			...
			<div class="margin-bottom-25">
				<img src="/Applications/MAMP/htdocs/nothi3/webroot/assets/admin/pages/media/gallery/image4.jpg">
				<div>
			...
			<div class="margin-bottom-25">
				<img src="/Applications/MAMP/htdocs/nothi3/webroot/assets/admin/pages/media/gallery/image3.jpg">
				<div>
			...
			<div class="margin-bottom-25">
				<img src="/Applications/MAMP/htdocs/nothi3/webroot/assets/admin/pages/media/gallery/image5.jpg">
				<div>
