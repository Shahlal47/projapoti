<div class="portlet light">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-gift"></i>Office Organogram Structure List</div>
        <div class="tools">
    ...
    <div class="portlet-window-body">
        <?= $this->Html->link('Add New Office Organogram Structure', ['action' => 'add'], ['class' => 'btn btn-default']) ?><br><br>
