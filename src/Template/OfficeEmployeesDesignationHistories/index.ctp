<div class="portlet light">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-gift"></i>Organization Designation List</div>
        <div class="tools">
    ...
    <div class="portlet-window-body">
        <?= $this->Html->link('Add New Designation', ['action' => 'add'], ['class' => 'btn btn-default']) ?><br><br>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td><?php echo $rows['org_designation_id']; ?></td>
